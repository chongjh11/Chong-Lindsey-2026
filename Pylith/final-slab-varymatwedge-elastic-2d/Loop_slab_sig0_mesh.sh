...
do
    ...
    cat "$CFG_TEMPLATE" > "step_slab_greens_sig0_final_log.cfg"

    # Run PyLith using the modified config file
    pylith "step_slab_greens_sig0_final_log.cfg"

    # Change the output directory name & move the temp config file into the output directory
    mv elastic_slab_sig0 "elastic_slab_sig0_${meshname}"
    mv step_slab_greens_sig0_final_log.cfg "./elastic_slab_sig0_${meshname}"
